...
header-img: img/react19/react19.png
catalog: true
...
<img src="../img/react19/npmdownload.jpg" />
...
- **ReactDOM.render 和 unmountComponentAtNode**
  ...
  - 解决方案：替换为 createRoot(),render 和 root.unmount()
    ...
    <img src="../img/react19/domRender.jpg" />
...
<img src="../img/react19/browser.jpg" />
